...
const fa = {
  ...
  bookingNoPay: 'هیچ پیش‌پرداختی لازم نیست — فقط با تأیید ما نوبت نهایی می‌شود.',
  bookingReservedNote: 'این نوبت یک درخواست است و پس از تماس تأیید، قطعی می‌شود.',
  stepPickTitle: 'انتخاب روز و ساعت',
  stepDetailsTitle: 'مشخصات شما',
  stepConfirmTitle: 'تایید و ارسال',
  ...
  bookingRefLabel: 'کد پیگیری رزرو',
  bookingSummaryHeading: 'خلاصه رزرو شما',
  summaryService: 'خدمت',
  summaryName: 'نام',
  summaryPhone: 'تماس',
  summaryDate: 'تاریخ',
  ...
  calendarGoogle: 'تقویم گوگل',
  calendarApple: 'تقویم اپل / iCal',
  calendarDownload: 'دانلود فایل تقویم',
  ...
  rescheduleTitle: 'نیاز به تغییر دارید؟',
  rescheduleText: 'تا زمان تأیید، می‌توانید با ما تماس بگیرید تا زمان یا خدمات را تغییر دهید.',
  callUsLabel: 'تماس با ما',
  contactAddressLabel: 'آدرس سالن',
  // Checkout page
...
const en: Dictionary = {
  ...
  bookingNoPay: 'No prepayment needed — your slot is only finalised once we confirm it.',
  bookingReservedNote: 'This is a booking request; it becomes confirmed after we call you back.',
  stepPickTitle: 'Pick day & time',
  stepDetailsTitle: 'Your details',
  stepConfirmTitle: 'Confirm & send',
  ...
  bookingSummaryHeading: 'Your Booking Summary',
  ...
  rescheduleTitle: 'Need to make a change?',
  rescheduleText: 'Until it is confirmed, feel free to call us to reschedule your time or service.',
  callUsLabel: 'Call us',
